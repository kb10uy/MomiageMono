...
## ダウンロード
現在の最新バージョンは **Build 1.3-20260714** です。

[Release ページ](https://github.com/kb10uy/MomiageMono/releases)から `MomiageMono-1.3-20260714.zip` をダウンロードしてください。
...
### 手順
1. 源暎モノゴを上記リンクからダウンロードして、 `fonts/gen-ei-mono-go/GenEiMonoGothic_v1.0.zip` に配置
2. `bash setup.bash`
